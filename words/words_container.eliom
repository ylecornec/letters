  ...
  Lwt.return
    (header
       ...
       [ a
           ...
           [txt Words_base.displayed_app_name]
           ()
       ; user_box ])
...
let%shared os_footer () =
  ...
  footer
    ...
    [ p
        ...
        ; a ~service:Words_services.os_github_service
            [txt " Ocsigen Start "] ()
        ; txt [%i18n S.footer_eliom_distillery]
        ; a ~service:Words_services.ocsigen_service [txt " Ocsigen "] ()
