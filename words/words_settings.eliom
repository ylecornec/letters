           ...
           Lwt_js_events.clicks (Eliom_content.Html.To_dom.of_element ~%button)
             (fun _ _ ->
               ...
               Eliom_client.change_page
                 ~service:Words_services.settings_service () ()))
        : unit)];
  button
...
let%shared select_language_form select_language_name =
  let open Eliom_content.Html in
  let current_language = Words_i18n.get_language () in
  let all_languages_except_current =
    List.filter (fun l -> l <> current_language) Words_i18n.languages
  in
  let form_option_of_language language is_current_language =
    D.Form.Option
      ( []
      , (* No attributes *)
        Words_i18n.string_of_language language
      , None
      , is_current_language )
  in
  ...
  Eliom_content.Html.D.
    [ div
        ...
        ; Os_user_view.upload_pic_link
            ...
            Words_services.upload_user_avatar_service
        ; br ()
